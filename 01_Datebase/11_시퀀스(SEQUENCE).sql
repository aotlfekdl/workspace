...
/*
    ...
    *캐시메모리 : 미리 발생될 값들을 생성해서 저장해두는 공간
                ...
                캐시메모리공간에 미리 생성된 값들을 가져달 쓸 수 있다. -> 속도가 빨라진다.
...
--[참고]현재 계쩡이 소유한 시퀀스들의 구조를 보고싶을 떄 
...
/*
    ...
    시퀀스명.NEXTVAL : 시퀀스값에 일정한 값을 증가시켜 발생한 값
                      현재 시퀀스 값에 INCREMENY BY 값 만큼 증가한 값
*/
SELECT * FROM USER_SEQUENCES;
...
SELECT SEQ_EMPNO.NEXTVAL FROM DUAL; --310  -- 315에러 발생 -> 최대값이 310이기 때문
