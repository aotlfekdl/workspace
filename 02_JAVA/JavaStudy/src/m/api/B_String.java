...
public class B_String {
	...
	public void method01() {
		...
		//Object t = new Object();
		//String클래스에서 equals메서드는 이미 오버라이딩 되어있음(주소값 비교가 아닌 값 비교)
		
		
		System.out.println(str1.hashCode());
		System.out.println(str2.hashCode());
		//String클래스에서 hashCode메서드도 이미 오버라이딩 되어있음(주소값이 아니라 문자열을 가지고 만듬)
	...
	public void method02() {
		...
		System.out.println("str1에 Hello라는 문자열 포함? : " + str1.contains("bey"));	
		
		
		//문자열.subsring(시작위치, 끝위치)
		//문자열을 시작위치부터 끝위치 -1까지 추출해서 반환
		System.out.println(str1.substring(6));
		System.out.println(str1.substring(6,9));
		
		
		//문자열.replace(대상문자문자, 변경할문자) : String
		//문자열에서 대상문자를 찾아서 변경한 문자로 변환된 문자열 반환
	...
	public void method03(){
		...
		//		String에서 제공하는 sqlit메서드 사용
		// 문자열.sqlit(구분자) : String[]
		...
		//더이상 토큰이 남아있지 않을 때 다음 토큰을 가져오려하면 예외 발생
