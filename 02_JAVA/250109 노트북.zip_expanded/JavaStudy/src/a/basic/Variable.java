...
public class Variable {
	...
	public static void main(String[] args) {
		...
		String str = "기차";
		//"기"  --> ""큰따음표는 String
		//'기' --> '' 따음표는 char 다른 자료형이다 
		// 현재까지는 String이 가장 큰 바이트를 차지하고 있다
		
	// 상수란? 한번만 쓰고 더이상 쓸 수 없는 메모리
		final int age; //--> final를 쓰면 상수 선언이다. 
		//상수 초기화
		//선언과 동시에 초기화 -->
		//final int num, = 100;
		 ...
		 *
		 * 정수 리터럴 기본저긍로 int타입으로 간주된다.
		 * 그러나 변수의 타입에 따라서 적절하게 변환되거나 명시적으로 변환해주어야 한다.
		 * byte, short 는 범위내에 있을 경우 자동으로 변환된다.
		 * 
		 * */
		 ...
		 * 문자열
		 * String(==============================객체--===============+=============================)
		 * 문자열 같은 경우 할당해야할 메모리 크기가 너무 가변적이므로 원시탕입이 아닌 객체로 변수를 만들어준다.
		 * */

		String str1 = "안녕하세요.안녕하세요. 안냥인냥";
		...
		/*
		 * 이스케이프 시퀀스
		 * 문자열 내에서 탭, 백스럴시, 작은따옴표 등을 코드로 사용하기 위한 방식
		 * 
		 * 탭문자 \t
		 * 백슬래시 \\
		 * 작은 따옴표 \'
		 ...
		 * 이름이 둘 이상의 단어로 되어있는 경우 '_' 언더바로 연결해준다.
		 * */
		final int MY_AGE;
		MY_AGE = 90;
		//MY_AGE = 30; 값을 초기화 하면 더이상 변경할 수 없다.
