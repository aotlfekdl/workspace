...
public class InformationService {
	...
	public int deleteMovietable(String tablename) {
		Connection conn = getConnection();
		int result = new InformationDao().deleteMovietable(tablename ,conn);
	...
	public ArrayList<Seat> movieSeat(String tablename, String tableNameSeat){
		ArrayList<Seat> list = new ArrayList<>();
		
		Connection conn = getConnection();
		list = new InformationDao().movieSeat(tablename,tableNameSeat , conn);
		
		return list;
	}
	
	public int movieReservation(String userid,String title,String tableNameSeat, String tablename, String seatrow, int seatnumber) {
		Connection conn = getConnection();
		
		int result;
		
		result = new InformationDao().movieReservation(userid,title,tableNameSeat, tablename, seatrow, seatnumber, conn);
	...
	public ArrayList<Movietitle> tablesearch(String title){
		ArrayList<Movietitle> list = new ArrayList();
		
		Connection conn = getConnection();
		
		list = new InformationDao().moviesearch(title, conn);
