...
<body>
    ...
    sOne과 sTwo가 일치하지않는가? ${sOne != sTwo} 또는 ${sOne ne sTwo} <br>
    
    big에 담긴 값과 10일 일치하는가? ${big ==10} 또는 ${big eq 10} <br>

    <%-- el구문안에서 문자열 리터럴값은 '', ""를 구분하지 않는다. --%>
    ...
    pOne이 null아닙니까? ${pOne != null} 또는 ${pOne eq null} 또는 ${empty pOne} <br>
    pTwo이 null아닙니까? ${pTwo != null} 또는 ${pTwo eq null} 또는 ${not empty pTwo} <br>
    ...
    flase || true : ${false || true} 또는  ${false or true} <br><br>
