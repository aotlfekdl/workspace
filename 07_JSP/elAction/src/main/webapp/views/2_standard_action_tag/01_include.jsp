...
<body>
	...
	<h4>1. 기존의 include지시어를 이용한 방식(정적 include방식 == 컴파일시 애초에 포함되어있는 상태 -> .jsp에서 .hava가 될 때 포함)</h4>
	
	<%-- 
	<%@ include file="footer.jsp" %>
	<br><br>
	
	특징 : include하고 있는 페이지상의 선언되어있는 변수를 현재 페이지에서도 사용가능 <br>
	include한 페이지의 year변수 : <%=year %> <br><br>
	
	=> 현재 페이지에서 동일한 이름의 변수를 선언할 수 없다.
	<%int year = 2025; %>
	--%>
