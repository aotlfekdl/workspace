...
public class BoardService {
	...
	public ArrayList<Board> selectDetail(int boardNo){
		Connection conn = getConnection();
		
		ArrayList<Board> list = new BoardDao().selectDetail(conn, boardNo);
	...
	public ArrayList<Board> selectThumbnail2(int thumbNo){
		Connection conn = getConnection();
		
		
		ArrayList<Board> list = new BoardDao().selectThumbnail2(conn, thumbNo);
